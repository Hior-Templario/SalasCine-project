...
class ClienteController {
    ...
    @GetMapping("/clientes") // Maneja las solicitudes GET a la ruta "/clientes"
    public String getClientes(Model model) {
        ...
        return "clientes"; // Nombre de la vista (clientes.html o clientes.jsp, depende de tu configuración)
    }
